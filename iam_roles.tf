resource "aws_iam_role" "eks_cluster_trust_role" {
  name = "eks-cluster-trust-role"
  ...
  tags = {
    tag-key = "eks-cluster-trust-role"
  }
}

resource "aws_iam_role_policy_attachment" "AmazonEKSClusterPolicy" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSClusterPolicy"
  role       = aws_iam_role.eks_cluster_trust_role.name
}
